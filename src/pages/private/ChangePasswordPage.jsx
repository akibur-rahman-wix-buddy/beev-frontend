...
const ChangePasswordPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="border border-[#E4DDD2] p-4.5 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg sm:rounded-[10px] space-y-5 sm:space-y-6 md:space-y-7 lg:space-y-8 xl:space-y-10 mt-5 sm:mt-6 md:mt-7 lg:mt-8 xl:mt-10">
