      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="flex items-center gap-2 text-sm sm:text-base lg:text-lg px-4 py-2 sm:py-2.5 sm:px-6 lg:px-8"
          >
            <FilterIcon className="size-4 sm:size-5 lg:size-6 shrink-0" />
            Filter
          </Button>
          <Button
            className="flex items-center gap-2 rounded-full text-sm sm:text-base lg:text-lg px-4 py-2 sm:py-2.5 sm:px-6 lg:px-8"
            asChild
          >
            <Link to="/add-post">
              <PlusIcon className="size-4 sm:size-5 lg:size-6 shrink-0" />
              Add Post
            </Link>
          </Button>
        </div>
